<template>
    <b-form @submit.prevent="submitProblemUpdate">
         ...
         <b-form-group
                ...
                label-for="input-2"
         >
             <froala :tag="input" :config="config" id="input-2" placeholder="Nhập nội dung" v-model="editForm.problem_statement"></froala>
         </b-form-group>
         <b-form-group
                id="input-group-3"
                label="Kiểu input:"
                label-for="input-3"
         >
             <froala id="input-3" :config="config" placeholder="Nhập nội dung" v-model="editForm.input_format"></froala>
         </b-form-group>
         <b-form-group
                id="input-group-5"
                label="Kiểu output:"
                label-for="input-5"
          >
             <froala id="input-5" :config="config" placeholder="Nhập nội dung" v-model="editForm.output_format"></froala>
         </b-form-group>
         <b-form-group
                id="input-group-4"
                label="Giàng buộc:"
                label-for="input-4"
          >
             <froala id="input-4" :config="config" placeholder="Nhập nội dung" v-model="editForm.constraints"></froala>
         </b-form-group>
         <b-form-group
                id="input-group-6"
                label="Mức:"
         ...
         <b-form-group
                ...
                label-for="input-8"
          >
             <b-form-select id="input-8" v-model="editForm.category_id" :options="options" size="sm" class="mt-3"></b-form-select>
         </b-form-group>
         <b-form-group
                id="input-group-10"
                label="JUnit:"
